...
function Home() {
  ...
  <section className='bg-gray-100'>
   <div className="py-20 lg:px-20 flex flex-col-reverse items-center md:flex-row
        px-6 bg-white/60">
        <div className="flex flex-col md:w-1/2 space-y-12">
            ...
            className="max-w-md text-center text-darkGrayishBlue
            md:text-left">
  ...
  className="lg:mx-24 mt-24">
    <div className="flex flex-col md:space-y-12 md:flex-row">
      ...
      <div className="text-center py-12 md:w-1/2">
          ...
          <p className="py-6 text-darkGrayishBlue md:px-0 px-4">
